...
export class BodyCareComponent implements OnInit {
  ...
  loadBodyCareProducts(): void {
    this.productService.getProductsByCategory(this.productCategoryId, this.currentPage, this.pageSize).subscribe(
      ...
      (error) => {
        console.error('Error loading Body Care products:', error);
      }
    );
  }
  ...
  goToDetails(id: number){
    this.router.navigate(['/body-product-details', id]);
  }
