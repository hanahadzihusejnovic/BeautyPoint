...
@Component({
  selector: 'app-hair-product-details',
  standalone: false,

  templateUrl: './hair-product-details.component.html',
  styleUrl: './hair-product-details.component.css'
})
export class HairProductDetailsComponent implements OnInit {
  product: any;
  productId!: number;
