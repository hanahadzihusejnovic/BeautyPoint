...
@Component({
  selector: 'app-skin-product-details',
  standalone: false,

  templateUrl: './skin-product-details.component.html',
  styleUrl: './skin-product-details.component.css'
})
export class SkinProductDetailsComponent implements OnInit {
  product: any;
  productId!: number;
  ...
  addReview() {
    ...
    this.showMessage("Review successfully added!");
  }
  ...
  onSaveUpdate() {
    ...
    this.showMessage("Review successfully updated!");
  }
